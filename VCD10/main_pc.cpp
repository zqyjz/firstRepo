// *****************************************************************************
// *   main_pc.cpp, for PC Desktop.
// *   Capture a real-life camera stream and convert to  cartoon.
// *   This file is for a desktop executable, but it  can also be used in an Android / iOS project.
// ******************************************************************************
...
const char *windowName = "JZDS";   // Name shown in the GUI window.
...
#include "CameraDetect.h"            // Detect a photo.
...
{
    cout << "OCV version " << CV_VERSION << endl;
    cout << endl;
